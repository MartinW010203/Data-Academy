...
create database if not exists demo6;
use demo6;

-- drop table if exists teacher; --
-- Create relational database  of tables for teaching course example --
...
-- Altering the tables to establish the relationships with FOREIGN KEYs
...
(1,  'James', 'Smith', 'ENG', NULL, '1985-04-20', 12345, '+441774553676'),
(2, 'Stefanie',  'Martin',  'FRA', NULL,  '1970-02-17', 23456, '+441234567890'), 
(3, 'Steve', 'Wang',  'MAN', 'ENG', '1990-11-12', 34567, '+447840921333'),
(4, 'Friederike',  'Müller-Rossi', 'DEU', 'ITA', '1987-07-07',  45678, '+442345678901'),
(5, 'Isobel', 'Ivanova', 'RUS', 'ENG', '1963-05-30',  56789, '+441772635467'),
(6, 'Martin', 'Walker', 'ENG', 'IRI', '1995-09-08',  67890, '+441231231232');
...
-- Complex Query  2 --
-- Get all particpants in classes taught by Martin Walker
